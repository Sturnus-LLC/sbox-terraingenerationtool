...
public class TerrainGenerationTool : Widget
{
	...
	Gradient SplatMapGradient = new Gradient( new Gradient.ColorFrame( 0.0f, Color.Cyan ), new Gradient.ColorFrame( 0.3f, Color.Red ), new Gradient.ColorFrame( 0.4f, Color.Yellow ), new Gradient.ColorFrame( 0.5f, Color.Green ), new Gradient.ColorFrame( 0.7f, Color.White ), new Gradient.ColorFrame( 0.9f, Color.Magenta ) );
	...
	public TerrainGenerationTool( Widget parent ) : base( parent, false )
	{
		...
		GenerateButton.Clicked += () =>
		{
			...
			float[,] heightmap = GenerateHeightmap( (int)Enum.Parse( typeof( TerrainDimensions ), TerrainDimensionsEnum.ToString() ),
				...
				TerrainMaxHeight,
				SmoothingPasses );
			float[,] splatmap = GenerateSplatmap( heightmap, _splatthresholds, TerrainMaxHeight );
